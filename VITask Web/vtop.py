...
def get_attendance(sess, username, id, semesterID="AP2021226"):
    """
...
def get_timetable(sess, username, id, semesterID="AP2021226"):
    """
    Returns Timetable 
    Format of timetable : {
        "Monday": [
...
def get_marks(sess, username, id, semesterID="AP2021226"):
    """
